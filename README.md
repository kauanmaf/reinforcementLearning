...
um modelo o qual faz uso de Reinforcement Learning para realizar
...
Nossa ideia é de que queremos aprender a sequência de movimentos de que maximize o retorno, num espaço pré definido de ações. Ou seja, dado um subespaço de 4 ações para o coder e também para o reviewer, queremos que o sistema aprenda o jeito mais rápido de deixar o código correto
...
### **1. Codificador (Coder)**
- **Função:** Gera novos códigos com base em seu estado atual e ações.
...
4. Ambos os agentes ajustam suas políticas com base nas recompensas recebidas.
...
- Duas camadas ocultas com 64 neurônios cada, ativação ReLU.
...
2. **Exploração Máxima:** Com probabilidade \(1-\epsilon\), seleciona a ação com maior valor \( Q(s, a) \).
...
### **Tentativa de Uso do Instructor**
